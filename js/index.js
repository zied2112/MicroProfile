...
data.forEach((data) => {
  const { title, src, description, lang, live, source } = data;
  ...
  var projectBtn = project.querySelector(".project-btn");
  projectBtn.addEventListener("click", () => {
    ...
    var closeProjectBtn = popup.querySelector(".popup-close-button");
